...
export default function AddTaskForm({ onAdd }: AddTaskFormProps) {
  ...
  return (
    <form
      ...
      className="flex w-full flex-col gap-3 rounded-2xl bg-gradient-to-br from-indigo-50 to-purple-50 p-3 shadow-sm dark:from-zinc-800 dark:to-indigo-950/50 sm:gap-4 sm:p-4"
    >
      <div className="flex w-full flex-col gap-2 sm:flex-row sm:gap-3">
        <input
          ...
          className="flex-1 rounded-xl border-2 border-indigo-200 bg-white px-3 py-2.5 text-sm text-zinc-900 shadow-sm outline-none transition focus:border-indigo-500 focus:ring-4 focus:ring-indigo-100 dark:border-indigo-900 dark:bg-zinc-900 dark:text-zinc-100 dark:focus:border-indigo-600 dark:focus:ring-indigo-900/50 sm:px-4 sm:py-3"
        />
        <button
          type="submit"
          className="rounded-xl bg-gradient-to-r from-indigo-600 to-purple-600 px-5 py-2.5 text-sm font-semibold text-white shadow-lg transition hover:from-indigo-700 hover:to-purple-700 hover:shadow-xl dark:from-indigo-500 dark:to-purple-500 dark:hover:from-indigo-600 dark:hover:to-purple-600 sm:px-6 sm:py-3"
        >
          Add Task
        </button>
      </div>
